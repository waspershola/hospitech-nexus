...
export const PERMISSIONS = {
  ...
  // Restaurant/Bar
  VIEW_RESTAURANT: [ROLES.OWNER, ROLES.MANAGER, ROLES.RESTAURANT, ROLES.KITCHEN, ROLES.BAR],
  MANAGE_ORDERS: [ROLES.OWNER, ROLES.MANAGER, ROLES.RESTAURANT, ROLES.KITCHEN, ROLES.BAR],
  ...
  REQUEST_FROM_STORE: [ROLES.OWNER, ROLES.MANAGER, ROLES.SUPERVISOR, ROLES.RESTAURANT, ROLES.KITCHEN, ROLES.BAR, ROLES.HOUSEKEEPING, ROLES.MAINTENANCE],
