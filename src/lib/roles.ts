...
export const PERMISSIONS = {
  ...
  VIEW_CONFIGURATION: [ROLES.OWNER, ROLES.MANAGER, ROLES.FINANCE],
  
  // Finance & Payments
  VIEW_FINANCE: [ROLES.OWNER, ROLES.MANAGER, ROLES.FINANCE],
  MANAGE_FINANCE: [ROLES.OWNER, ROLES.MANAGER],
  ...
  VIEW_ROOMS: [ROLES.OWNER, ROLES.MANAGER, ROLES.FRONTDESK, ROLES.HOUSEKEEPING],
  SET_MAINTENANCE: [ROLES.OWNER, ROLES.MANAGER],
  ...
  // Reports
  VIEW_REPORTS: [ROLES.OWNER, ROLES.MANAGER, ROLES.FINANCE],
  EXPORT_DATA: [ROLES.OWNER, ROLES.MANAGER],
