...
import continentalBreakfast from '@/assets/menu/continental-breakfast.jpg';
...
const SAMPLE_IMAGES: Record<string, string> = {
  'jollof': jollofRice,
  'breakfast': continentalBreakfast,
  'juice': freshJuice,
  'cake': chocolateCake,
  'sandwich': clubSandwich,
  'pasta': pastaCarbonara,
};

export function QRMenuBrowser() {
      ...
      <div className="sticky top-0 z-50 bg-background/95 backdrop-blur-md border-b border-border shadow-md">
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-display font-bold text-foreground">Digital Menu</h1>
