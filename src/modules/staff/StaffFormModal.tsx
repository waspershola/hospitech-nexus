...
export function StaffFormModal({ open, onClose, staff, availableSupervisors }: StaffFormModalProps) {
  const { createStaff, updateStaff } = useStaffManagement();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (staff) {
      await updateStaff.mutateAsync({ id: staff.id, ...formData });
    } else {
      await createStaff.mutateAsync({ ...formData, status: 'active', user_id: '' });
    }
