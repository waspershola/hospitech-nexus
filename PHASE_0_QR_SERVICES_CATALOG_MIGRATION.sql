-- ============================================================
-- PHASE 0 MIGRATION: QR Services Catalog
-- ============================================================
-- This migration creates a tenant-specific QR services catalog
-- that allows hotels to customize which services are available
-- through their QR codes.
--
-- DEPLOYMENT INSTRUCTIONS:
-- This SQL needs to be added as a Supabase migration file:
-- supabase/migrations/[timestamp]_create_qr_services_catalog.sql
--
-- Or execute directly in Supabase SQL Editor
-- ============================================================

-- Create QR Services Catalog Table
...
CREATE INDEX IF NOT EXISTS idx_hotel_qr_services_catalog_tenant_id 
  ON hotel_qr_services_catalog(tenant_id);
CREATE INDEX IF NOT EXISTS idx_hotel_qr_services_catalog_active 
  ON hotel_qr_services_catalog(active);
