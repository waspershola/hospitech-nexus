-- Update booking_confirmed template with rich HTML
...
-- Create check_in_welcome template (delete existing first if needed)
...
<body>
  <div class="header">
    ...
    <p style="margin: 10px 0 0 0; font-size: 16px; opacity: 0.95;">You are all checked in</p>
  </div>
  <div class="content">
    <p style="font-size: 16px; margin-top: 0;">Dear <strong>{{guest_name}}</strong>,</p>
    <p>Welcome! We are delighted to have you staying with us. Your room is ready and we hope you have a wonderful stay.</p>
...
Welcome! We are delighted to have you staying with us.
