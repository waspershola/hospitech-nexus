-- Fix type mismatch in create_group_master_folio: group_bookings.group_id is UUID, so compare UUID to UUID
...
BEGIN
  ...
  INSERT INTO finance_audit_events (
    ...
    jsonb_build_object(
      ...
      'version', 'GROUP-MASTER-FOUNDATION-V1-FIX-UUID-UUID'
    )
  );
