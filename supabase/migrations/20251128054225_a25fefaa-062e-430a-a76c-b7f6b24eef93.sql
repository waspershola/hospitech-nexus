-- Fix insert_ledger_entry function to match actual table schema
-- Version: LEDGER-FUNCTION-FIX-V1
...
BEGIN
  ...
  INSERT INTO ledger_entries (
    ...
    p_metadata || jsonb_build_object(
      ...
      'ledger_version', 'LEDGER-FUNCTION-FIX-V1',
      'created_via', 'insert_ledger_entry'
    )
  )
  RETURNING id INTO v_ledger_id;

  RAISE NOTICE '[LEDGER-FUNCTION-FIX-V1] Created ledger entry: %', v_ledger_id;
  RETURN v_ledger_id;
EXCEPTION
  WHEN OTHERS THEN
    RAISE WARNING '[LEDGER-FUNCTION-FIX-V1] Failed to insert ledger entry: %', SQLERRM;
    RAISE;
END;
$$;